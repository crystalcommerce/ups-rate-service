...
async def lifespan(app: FastAPI):
  logger.info("Starting Shipping Rate Microservice")
  yield
  logger.info("Shutting down Shipping Rate Microservice")

app = FastAPI(
  title="Shipping Rate Microservice",
  description="Ship Rates API",
  version="1.0.0",
  lifespan=lifespan
)
